...
{
    // 定时器成功触发，说明按键已经稳定，抛出按键事件
    ESP_LOGI(TAG, "Button press stable! Posting APP_EVENT_BTN_PRESSED");

    esp_event_post(APP_EVENT, APP_EVENT_BTN_PRESSED, NULL, 0, portMAX_DELAY);
}
